...
function MainApp() {
  ...
  // State for real-time Firestore collections
  ...
  useEffect(() => {
    ...
    const unsubRequests = subscribeClearanceRequests((data) => setRequests(data));
    const unsubAudits = subscribeAuditLogs((data) => setAuditLogs(data));
